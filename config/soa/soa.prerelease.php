...
return [
    /************************************* 选品系统配置 ***********************************/
    'ips' => [
        'host' => 'http://ips.gw-ec.com',
        'apiUrlPrefix' => 'http://ips.gw-ec.com/api',
    ...
    'sop' => [
        'api' => [
            'host' => 'http://sop.glosop.com',
            'secretKey' => 'qc3QPHx9OmNn4kId',
        ],
        'addRuleUrl' => 'http://sop.glosop.com/#/shop/rule/add'
    ],
    ...
    'gb'  => [
        // SOA环境相关设置
        'env'                      => [
            'gateway' => 'http://gb-mall-outer.gw-soa.com/gateway',
            //'tokenId' => '8a2c96bd4f4ddfcb44e84216a27e8c93',
            'tokenId' => '8a2c96bd4f4ddfcb44e84216a27e8c93',
            'version' => '1.0.0',
            'type'    => 1
        ],
        ...
        'uiGoodsInfoMethodMapping' => [
            ...
            'U000123' => 'getGeneralGoodsList', //单个推荐(GB) 桌面
            'U000124' => 'getGeneralGoodsList', //单个推荐(GB) 移动
            'U000158' => 'getGeneralGoodsList', //普通商品列表组件(GB) 移动
    ...
    /************************************* obs系统配置 ********************************/
    'obs' => [
        'apiUrlPrefix' => 'http://work.gw-soa.com/api/geshop',
    ],
];