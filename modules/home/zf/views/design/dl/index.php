...
<style>
    ...
    #page_lang_temp input{
        vertical-align:middle;
        margin-right:5px;
    }
    #page_lang_temp label{
        margin-right:10px;
    }
    /* 滚动条 */
                ...
                <div class="sidebar-list-container">
                    ...
                    <ul class="sidebar-component-container sidebar-component-container-big" style="max-height: 75vh">
                        ...
                        <?php foreach ((array)$data['ui'] as $value) { ?>
                            <li class="design-model-item component-drag" draggable="true" data-key="<?= $value->component_key ?>" <?php if ($value->component_key == 'U000055' || $value->component_key == 'U000179' ): ?>data-unique="true"
                            <?php endif; ?> data-name="
                            <?= $value->name ?>">
...
<input type="text" name="templateName" class="layui-input" placeholder="组件筛选">
    ...
    <div class="design-right">
        <div class="el-row design-control">
            ...
            <div>
                ...
                <div class="el-col el-col-8" style="text-align: center;">
                    <a id="switch_to_tabletop" href="javascript:;" class="layui-btn layui-btn-sm layui-btn-normal">桌面端</a>
                    <a id="switch_to_tablet" href="javascript:;" class="layui-btn layui-btn-sm layui-btn-primary">平板端</a>
                    <a id="switch_to_mobile" href="javascript:;" class="layui-btn layui-btn-sm layui-btn-primary">移动端</a>
                </div>
        ...
        <div id="design_view" class="design-view" style="margin: 72px auto 0; border: 0; width: 1366px; padding-bottom: 10px;">
