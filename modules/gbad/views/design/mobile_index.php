<script type="text/javascript">
    ...
    var GESHOP_ACTIVITYTYPE = <?php echo $activityType;?>;
...
if (0 === substr_compare($siteCode, 'gb-', 0, strlen('gb-'))) {
    $this->registerJsFile(
			app()->url->assets->js('resources/sitesPublic/gb-wap/js/gs_common_activity.js'),
        ['position' => \yii\web\View::POS_BEGIN]
		);
    ...
    <header class="site-header-container">
        ...
        <div class="right">
            <form class="layui-form" action="">
                ...
                <button type="button" id="gbad_view_page" class="btn">访问</button>
                <button type="button" id="gbad_generate_page" class="btn active">发布</button>
            </form>
        </div>
    </header>
<main class="site-main-design site-wap-design gb-main-design">
                    ...
                    <div class="sidebar-list-container">
                        ...
                        <ul class="sidebar-component-container sidebar-component-container-big" style="max-height: 75vh">
                            ...
                            <li class="design-model-item component-drag" draggable="true" data-key="<?= $value->component_key ?>"
                                <?php if ($value->component_key == 'U000056'): ?>data-unique="true"<?php endif; ?>
        ...
        <div class="design-right">
                ...
                <div>
                    ...
                    <div class="el-col el-col-12">
                        ...
                        <p class="design-control-option">
                            ...
                            <a href="javascript:;" id="gbad_generate_page_model">
            ...
            <div id="geshop-page-content" style="width: 385px;margin-left: auto;margin-right: auto;">
							<div id="design_view" class="design-view layout-drop"  style="margin:0 auto 20px;width:385px;">
									<?= $pageHtml; ?>
							</div>
            </div>
    ...
    <input id="gb_page_type" type="hidden" value="gbad">
...
<?php
include_once(app()->basePath.'/htdocs/resources/tpl/commontpl/tpl_component_stylesheet_m.html');
?>
...
$this->registerJsFile(
    app()->url->assets->js('resources/javascripts/design.activity.gbad.js'),
    ['position' => \yii\web\View::POS_END]
);
