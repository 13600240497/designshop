...
use app\modules\common\gb\models\{
    ActivityModel,PageModel,PageUiModel,PageLanguageModel,PageLayoutModel,PageLayoutDataModel,PageUiComponentDataModel,
    GoodsManagePageModel,GoodsManageDataBlockModel
};
use app\modules\common\components\{
    CommonPageConfig,CommonPageLayoutDesignComponent,CommonPageUiDesignComponent,CommonCommonComponent
};
...
use app\modules\activity\gb\components\{
    PageComponent,PageUiComponentDataComponent
};
...
class GoodsManageComponent extends Component
{
    ...
    /** @var string IOS站点 */
    const DEVICE_CODE_IOS = SitePlatform::PLATFORM_CODE_IOS;
    /** @var string ipad站点 */
    const DEVICE_CODE_IPAD = SitePlatform::PLATFORM_CODE_IPAD;
    /** @var string android站点 */
    const DEVICE_CODE_ANDROID = SitePlatform::PLATFORM_CODE_ANDROID;
    ...
    private $defaultLayoutComponentKey = [
        ...
        self::DEVICE_CODE_IOS     => 'L000019',
        self::DEVICE_CODE_IPAD    => 'L000019',
        self::DEVICE_CODE_ANDROID => 'L000019',
    ];
    ...
    private $uiComponentKey = [
        ...
        self::DEVICE_CODE_IOS     => GoodsManageDataBlockModel::GOODS_TITLE_COMPOSITE_COMPONENT_KEY_MOBILE,
        self::DEVICE_CODE_IPAD    => GoodsManageDataBlockModel::GOODS_TITLE_COMPOSITE_COMPONENT_KEY_MOBILE,
        self::DEVICE_CODE_ANDROID => GoodsManageDataBlockModel::GOODS_TITLE_COMPOSITE_COMPONENT_KEY_MOBILE
    ];
    ...
    public function lists($params)
    {
        ...
        $conditions = ['p.site_code' => $siteCode];
    ...
    public function editGroup($groupId)
    {
        ...
        $activityList = ActivityModel::find()
            ->where(['is_delete' => ActivityModel::NOT_DELETE])
...
//                }
    ...
    public function checkGoodsExists($params)
    {
        ...
        $params['uiId'] = !empty($params['uiId']) ?? '';
        // 获取站点下指定sku商品数据
        $explainComponent = new ExplainComponent();
        $responseSku = $explainComponent->getGoodsList($params['skuList'], $params['lang'], $params['siteCode'], $params['uiId']);
    ...
    {
        if (empty($pid) || empty($params['lang']) || empty($params['content'])) {
            return '参数不全';
        }
...
//        $pageDesignComponent = new PageDesignComponent();
//        $html = $pageDesignComponent->preview($pid, $lang);
...
//        }
     ...
     * 能预览页面配置的商品
     *
     * @See \app\modules\common\traits\CommonPublishTrait::getPageLayoutAndUiByPageId
     * @deprecated 没有使用，但不删除，以便以后使用
     */
