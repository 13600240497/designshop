...
use app\modules\common\dl\components\CommonPageUiDesignComponent;
use app\modules\common\dl\models\ActivityModel;
use app\modules\common\dl\models\PageModel;
use app\modules\common\dl\models\PageUiDataModel;
use app\modules\common\dl\models\PageUiModel;
use app\modules\common\dl\models\PageLanguageModel;
use app\modules\common\dl\models\PageLayoutModel;
use app\modules\common\dl\models\PageLayoutDataModel;
use app\modules\common\dl\models\PageUiComponentDataModel;
use app\modules\common\dl\models\GoodsManagePageModel;
use app\modules\common\dl\models\GoodsManageDataBlockModel;
use app\modules\common\dl\components\CommonPageConfig;
...
use app\modules\activity\dl\components\PageComponent;
use app\modules\activity\dl\components\PageDesignComponent;
use app\modules\activity\dl\components\PageUiComponentDataComponent;
...
class GoodsManageComponent extends Component
{
     ...
     *
     * @see \app\modules\common\dl\components\CommonPageTplComponent::getPageInfo
     */
