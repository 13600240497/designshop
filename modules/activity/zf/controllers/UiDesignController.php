 ...
 * 活动页面Ui设计管理类
 *
 * @property \app\modules\activity\zf\components\PageUiDesignComponent $PageUiDesignComponent
 * @property \app\modules\activity\zf\components\PageUiComponentDataComponent $PageUiComponentDataComponent
 * @author wangmeng
 *
 */
class UiDesignController extends DesignController
{
	 ...
	 * @throws \ego\base\JsonResponseException
	 */
    public function actionSaveNativeForm()
    {
	    return $this->PageUiDesignComponent->saveNativeForm(app()->request->post());
    }
