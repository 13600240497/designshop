 ...
 */
class ComponentTplSiteRelationModel extends ComponentModel
{
    /**
     * 组件类型|1-layout
     */
    ...
    {
        return 'component_tpl_site_relation';
    }
    ...
    {
        return [
            [['type', 'tpl_id', 'site_code'], 'required'],
            [['type', 'tpl_id'], 'integer'],
        ];
    }
     ...
     */
    public static function saveSiteRelation($tplId, $type, $range, $siteGroups)
    {
    ...
    private static function getFullSiteCode(array $siteArr, int $range)
    {
        ...
        if (!empty($siteArr)) {
            foreach ($siteArr as $site) {
                ...
                } elseif ($range === UiModel::RANGE_WAP) { // wap和app公用
