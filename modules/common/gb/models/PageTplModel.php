 ...
 */
class PageTplModel extends BaseModel
{
    public $query;
     ...
     * @return array
     */
    public static function getTemplateList($place, $range, $lang)
    {
        $username = app()->user->username;
        $where = 'is_delete=0 AND (tpl_type=1 OR (tpl_type=2 and create_user="'.$username.'")) AND lang = "'.$lang.'"';
