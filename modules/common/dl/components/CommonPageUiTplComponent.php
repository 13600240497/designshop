...
/**
 * 页面模板管理组件
 * @property \app\modules\common\dl\components\CommonPageUiComponentDataComponent $commonPageUiComponentDataComponent
 */
class CommonPageUiTplComponent extends Component
{
    ...
    public function add($params)
    {
        ...
        /** @var  \app\modules\common\dl\models\PageUiModel $pageUiModel */
        ...
        // 保存组件模板
        /** @var  \app\modules\common\dl\models\PageUiTemplateModel $templateModel */
    ...
    public function getUiComponentList($params)
    {
        ...
        list($websiteCode, $platformCode) = SitePlatform::splitSiteCode($params['site_code']);
        $rangeType = (SitePlatform::PLATFORM_CODE_WEB == $platformCode) ? ComponentModel::RANGE_PC : ComponentModel::RANGE_WAP;
        $listParams = [
            'type'      => 2, // 组件类型(1 布局 2 UI)
            'status'    => 3,
            'place'     => $params['place'] ?? NULL,
            'range'     => [$rangeType, ComponentModel::RANGE_RESPONSIVE],
