        ...
        <div class="list" v-if="list.length > 0">
            <div class="list-item" v-for="(item, index) in list" :key="index">
                ...
                <div class="item-footer">
                    <a href="javascript:;" class="deep-link" :data-clipboard-text="item.deep_link">复制deeplink</a>
                    <a href="javascript:;" class="deep-link" :data-clipboard-text="item.group_id">复制ID</a>
                </div>
            </div>
        </div>
...
<style lang="less">
    .geshop-new-child-page .el-dialog__body {
