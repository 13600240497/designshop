<template>
    <el-container>
        ...
        <el-container :style="{ minHeight: containerHeight + 'px' }" class="site__promotion--close">
...
export default {
    name: 'layout',
    components: { siteHeader, siteAside, weLink },
    props: {
        'footLink': Number
    },
    data () {
...
<style lang="less">
    ...
    // 站点大促关闭一键刷新
    .site__promotion--open {
        .geshop-Activity-btn-refresh, .geshop-index-btn-refresh, .geshop-gb-btn-refresh {
            display: none;
        }
    }
</style>
