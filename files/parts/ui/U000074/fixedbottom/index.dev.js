$(function() {
  ...
  $('.geshop-U000074-fixedbottom').each(function(){
    var $component = $(this);
    ...
    $LAB.script(staticDomain + '/resources/javascripts/library/swiper/swiper.3.4.spec.min.js').wait(function () {
      ...
      if(slideLen >= 4){
        ...
        var mySwiper = new Swiper3($component.find('.swiper-container'), {
          ...
          loop : true,
          slidesPerGroup: 1,
          prevButton:$component.find('.btn-prev'),
          nextButton:$component.find('.btn-next'),
          lazyLoading : true,
    ...
    $('body').on("click",function(e){
      ...
      if(editEnv == 0){
        ...
        if(element && !$(element).hasClass("slider") && !$(element).hasClass("deals-main-container") && !$(element).hasClass("swiper-button") && !$(element).hasClass("swiper-img") && !$(element).hasClass("swiper-button") && !$(element).hasClass("deal-button") && !$(element).hasClass("pagation-img") && !$(element).hasClass("img-fold")){
