<template>
    <div class="geshop-u000218-default-body" :class="[{ 'geshop-hidden-box': noPreview }]" :style="style_body">
        <ul>
...
<!--                        <a :href="item.url_title" v-if="item.goods_number > 0" target="_blank">{{ item.goods_title-->
<!--                            }}</a>-->
