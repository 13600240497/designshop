$(function () {
  ...
  $('.nwrap-u000029-default-av-vertical-ul-wrap').width($('.nwrap-u000029-default-av-vertical-ul>li').outerWidth());
  ...
  navigateTarget.on('click', 'li.component-nav-vertical-item', function () {
    var target = $(this);
    var navigatedId = target.data('id');
