...
(function () {
        ...
        U000152 : function(element){
           ...
           var staticDomain = $('[data-static-domain]:eq(0)').attr('data-static-domain') ? $('[data-static-domain]:eq(0)').attr('data-static-domain') : "";
            ...
            var _addCountDown1 = function _addCountDown1($li,item){
                ...
                //这里是用来判断是否销售完了
                var activity_number = parseInt(item.activity_number);//活动库存
                var activity_volume_number = parseInt(item.activity_volume_number); //活动库存销量
    ...
    $(function () {
        $('[data-module="U000152"]').each(function(index,el){
            $(el).U000152(el);
        });
    });
})();
