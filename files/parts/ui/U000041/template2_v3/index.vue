<template>
    <div class="geshop-U000041-template2_v3 geshop-col-12" ref="myTabWrap">
        <div class="gs-tab">
            <!-- 头部导航 -->
...
<!--                                <a :href="item.url_title" class="buy-content" target="_blank">-->
<!--                                    <geshop-buynow></geshop-buynow>-->
<!--                                </a>-->
                            </div>
                        </li>
