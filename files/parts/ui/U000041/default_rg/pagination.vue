<template>
    <div class="GESHOP_pagination" v-show="showPage" v-if="oPage.pageCount > 1">
        <!-- prev -->
...
export default {
    ...
    watch: {
        total () {
            ...
            this.oPage.total = Number(this.total);
            this.oPage.pageCount = Number(this.pageCount);
            this.oPage.pagerCount = Number(this.pagerCount);
        },
        currentPage () {
            this.oPage.currentPage = Number(this.currentPage);
            this.oPage.pageSize = Number(this.pageSize);
