<template>
    <div class="geshop-U000041-rg_template3_v3 geshop-col-12" ref="myTabWrap" v-show="compShow">
        <div class="gs-tab">
            <!-- 头部导航 -->
            <div class="fixed-wrap">
                <div class="tab-wrap">
                    <div class="tab-nav-box">
                        ...
                        <div class="swiper-button-prev rg_template3_v3-prev hide" slot="button-prev"></div>
                        <div class="swiper-button-next rg_template3_v3-next hide" slot="button-next"></div>
                    </div>
                </div>
            </div>
                        ...
                        <!--<li class="list-item" v-for="(item, index) in showNum(dataArr) || 4" :key="item.goods_sn + index">-->
                            <div class="list-item-img">
                                <geshop-analytics-href
                                    ...
                                    <!--折扣-->
                                    <geshop-discount :value="typeof item.discount != 'undefined' ? item.discount : 50">
                                    </geshop-discount>
                                    <!--售罄-->
                                </geshop-analytics-href>
                                <span class="quick_view" :class="{'show': item.goods_number - 0 > 0}" @click="handleQuick(item.url_quick)">
                                    {{ languges.quick_view }}
                                </span>
                                <geshop-soldout
                                        :type="'bottom'"
    ...
    data () {
        return {
            ...
            swiperOption: {
                ...
                navigation: {
                    nextEl: '.rg_template3_v3-next',
                    prevEl: '.rg_template3_v3-prev'
                }
            },
            compShow: true,
...
<style lang="less">
    .geshop-U000041-rg_template3_v3 {
        .swiper-container {
            overflow: visible;
        }
