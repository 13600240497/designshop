<template>
    <div class="geshop-u000236-model1-body" :style="boxStyle" :class="noPreview ? 'component-hide' : ''">
                ...
                <div class="list_item">
                    ...
                    <div class="item_content">
                        ...
                        <div class="item_market_price font_regular">
                            <template v-if="Number(item.shop_price) < Number(item.market_price) || mockData === true">
