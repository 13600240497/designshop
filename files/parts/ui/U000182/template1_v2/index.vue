<template>
    <div class="geshop-U000182-template1-v2-body" v-show="show" ref="component">
        ...
        media_platform (val, oldVal) {
            ...
            if (this.pageSize >= 1 && val === 'wap' || val === 'app') {
                ...
                this.view_more = Object.assign(this.view_more, {
                    isMore: dataGroup.length > 1 ? true : false,
                    isLess: false,
                    view_more_scroll_top: 0
                });
            } else {
    ...
    methods: {
        ...
        showMoreOrLess (type) {
            ...
            if (type === 1) {
                ...
                if (oldData.length < this.goodsInfo.length) {
