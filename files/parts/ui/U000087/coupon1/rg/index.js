;$(function () {
        ...
        U0000871 : function($box){
            ...
            $.extend(CountDown.prototype, {
                ...
                removeCountDownBox : function(){
                    this.$node.find('.coupon-middle').remove();
                },
                // {# 判断当前优惠券属于哪个状态 times 包含优惠券起始时间跟结束时间 #}
                judge: function(data) {
                    this.current_coupon_id = data.couponInfo.id;
                    this.receivedCount = data.couponInfo.receivedCount;
                            ...
                            _jsonp({
                                ...
                                data: {
                                    content: JSON.stringify({
                                        lang : lang,
                                        couponid : _this.current_coupon_id,
    ...
    $('[data-module="U000087-1"]').each(function(index, el) {
        $(el).U0000871();
    });
});
