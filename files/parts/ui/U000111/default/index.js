...
$(function () {
	var isEditEnv = $('.geshop-component-box-U000111-default [data-editenv]:eq(0)').data('editenv');
	if (isEditEnv == '1') {
		return false;
	}
	function initOffset () {
		var documentH = document.documentElement.clientHeight;
		var $wrapper = $('.geshop-component-box-U000111-default .geshop-page-navigator');
	...
	$('.geshop-component-box-U000111-default .side-btn').on('click', function () {
	...
	$('.geshop-component-box-U000111-default .geshop-page-goTop').click(function () {
		$('body,html').animate({
			scrollTop: '0px'
		}, 500)
	})
