<template>
    <div class="geshop-u000031-default-v2-body" :style="style_body"
                    ...
                    <div class="item-info">
                        ...
                        <div class="item-title">
                            <geshop-analytics-href
                                :item="item"
                                :index="index">
                                {{ item.goods_title || goodsTitleDefault }}
                            </geshop-analytics-href>
                        </div>
...
export default {
    ...
    data () {
        return {
            ...
            goodsTitleDefault: 'ZAFUL Asymmetric Striped Slit Shirt Dress - Dark Gree …'
        };
    },
    computed: {
...
<style lang="less" scoped>
    .geshop-u000031-default-v2-body {
        display: flex;
    ...
    .geshop-u000031-default-v2-body.is-whole {
        ul {
