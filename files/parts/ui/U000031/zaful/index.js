...
(function(){
	function turnGoods () {
		$('[data-gid=U000031_zaful]').each(function (index, element) {
	...
	if (!GS_goods_kill_normal) {
		...
		if (!GS_goods_kill_normal) {
			var GS_goods_kill_normal = function (my) {
				var $gsCountTarget = $('.warp-U000031_zaful .gs-goods-singleTab-zaful .gs_component_countDown');
				my.initCountDown = function () {
					$gsCountTarget = $('.warp-U000031_zaful .gs-goods-singleTab-zaful .gs_component_countDown');
				...
				my.compoentCountDown = function () {
					...
					$gsCountTarget.each(function () {
						...
						var $wrapper = $self.parents('[data-gid="U000031_zaful"]:eq(0)');
				...
				my.tabScrollEvent = function () {
					var $goodTarget = $('.warp-U000031_zaful .gs-goods-singleTab-zaful');
		...
		/* edit */
		var $component = $('.warp-U000031_zaful');
		var isEditEnv = $('[data-editenv]:eq(0)').data('editenv');
		if (isEditEnv == '1') {
