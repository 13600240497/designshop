<template>
    <div class="geshop-u000031-default-v3-body" v-if="list.length > 0" :style="style_body"
         :class="[{ 'is-whole': whole },userGroupClass,{ 'geshop-hidden-box': noPreview }]"
         :data-id="pid">
    ...
    methods: {
        ...
        initMounted () {
            ...
            if (this.data.goods_fixed_show_number != '') {
                ...
                let fixed_show_number = this.data.goods_fixed_show_number ? this.data.goods_fixed_show_number : 0;
                if (fixed_show_number && oldList.length > Number(fixed_show_number)) {
                    this.list = oldList.slice(0, fixed_show_number);
                }
            }
