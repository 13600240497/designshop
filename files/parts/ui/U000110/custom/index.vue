<template>
    <div class="geshop-u000110-custom-body" :style="style_body" :data-id="pid">
...
export default {
    ...
    mounted () {
        ...
        if (this.data.goodsInfo && this.data.goodsInfo.length > 0) {
            ...
            this.arrData = this.data.goodsInfo; // 拷贝备用, 用于more加载全部
    ...
    methods: {
        ...
        styleCss (url) {
            ...
            const left = this.data.list_img_left || 24;
