$(function () {
    var tab_item = $('[data-gid="U000110_hotSaleList"] .gs-tab-box li');

    $('[data-gid="U000110_hotSaleList"] .gs-tab-box').each(function () {
        var $box = $(this),
    ...
    var $hotSaleList = $('.wrap-U000110_hotSaleList');
...
(function () {
    ...
    var LBTplObj = {
        renderTpl: function () {
            ...
            // 遍历 - 兼容多个组件各自获取数据
            $('.geshop-leaderboard-async-list[data-gid="U000110_hotSaleList"]').each(function (i, element) {
                var $ele = $(element);
                ...
                //   limit: 10,
                //   groups: 0,
                //   prev: '<div class="prev-page"></div>',
                //   next: '<div class="next-page"></div>',
                // });
