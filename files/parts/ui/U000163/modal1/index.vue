<template>
    <div class="geshop-u000163-modal1-body" v-if="list.length > 0">
        <div class="geshop-u000163-modal1-wrapper">
            <ul>
                <template v-for="(item, index) in list">
                    <li
                        ...
                        :style="{ 'border-radius': $px2rem($root.data.goodsBRadius || 12) }">
...
.geshop-u000163-modal1-body {
    width: 100%;
}
.geshop-u000163-modal1-wrapper {
    width: 100%;
    overflow: hidden;
    margin: 0 auto;
