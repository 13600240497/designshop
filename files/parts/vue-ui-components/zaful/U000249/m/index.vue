            ...
            <li v-for="(item, index) in list" :key="`${index}-${item.goods_sn}`">
                ...
                <div class="item-info">
                    ...
                    <div class="item-promotions" v-if="item.promotions && item.promotions.length > 0">
                        <div class="gs-off-more">
                            <template v-for="(promotion, key) in item.promotions" >
                                <div class="gs-off-text" v-html="promotion_filter(promotion)" :key="key"></div>
                            </template>
                        </div>
                    </div>
                </div>
